...
campaign_date_outcomes_comp_4_vid %>% 
        DT::datatable(caption = "Tests 4 (roughly comparable); blank cells indicate NA/no results", filter="top",  rownames= FALSE) 
