...
us_cities_pop <- read.csv("uscities_pop.csv") %>%
...
### Plotting the 'difference in difference' (work in progress)
...
<!--chapter:end:tlycs_portland_trial_2021/input_simple_analysis.Rmd-->
...
(Here we should merge in the analysis done in  [HERE](https://rethinkpriorities.github.io/methodology-statistics-design/inference-and-rough-equivalence-testing-with-binomial-outcomes.html#how-likely-are-proportions-this-similar-under-different-size-true-effect-sizes))

<!--chapter:end:oftw_giving_season_upsell_2021_trial/oftw_upsell_input_first_analysis.Rmd-->
