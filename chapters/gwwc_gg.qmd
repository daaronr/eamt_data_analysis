...
Rp100usd_vid_text_audience0_rep <- model_data_0_rep %>%  
  lm(
...
Rp100usd_vid_text_audience0$df.residual <- sum(model_data_0$impressions) - length(coef(Rp100usd_vid_text_audience0))

Rp100usd_vid_text_audience_startsdf.residual <- sum(model_data_start$impressions) - length(coef(Rp100usd_vid_text_audience_starts))

Rp100usd_vid_text_audience_demo$df.residual <- sum(model_data$impressions) - length(coef(Rp100usd_vid_text_audience_demo))

huxtable::huxreg(Rp100usd_vid_text_audience0, Rp100usd_vid_text_audience0_rep, Rp100usd_vid_text_audience_starts, Rp100usd_vid_text_audience_demo)


```
 
 Note: the N and R-sq values above are incorrect; this needs to account for the frequency  regression ne
