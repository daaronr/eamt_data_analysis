...
campaign_date_outcomes_comp_4 %>% filter(`$/ result`<=9.1) %>% dplyr::select(audience, video_theme, `$/ result`) 
...
campaign_date_outcomes_comp_4 %>% filter(`$/ result`>20 |  is.na(`$/ result`) ) %>% dplyr::select(audience, video_theme, `$/ result`) 
